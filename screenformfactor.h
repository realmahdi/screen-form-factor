...
class screenformfactor : public QQuickItem
{
    ...
    Q_PROPERTY(bool is_laptop READ is_laptop NOTIFY is_laptop_changed)
    Q_PROPERTY(bool is_desktop READ is_desktop NOTIFY is_desktop_changed)

public:
    screenformfactor(QQuickItem *parent=Q_NULLPTR);

    enum e_form_factor { NONE, PHONE, PHABLET, TABLET, LAPTOP, DESKTOP };
    ...
    void set_is_laptop(bool is_laptop);
